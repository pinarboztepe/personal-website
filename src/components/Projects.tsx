...
export default function Projects() {
    return (
        <section id="projects" className="py-16 bg-gray-100">
            ...
            <h1 className="text-4xl font-bold text-center text-black mb-16 mt-16">Projects</h1>
