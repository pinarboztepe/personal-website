        ...
        <section id="projects" className="py-16 bg-gray-200 dark:bg-zinc-800">
            ...
            <div className="container mx-auto flex flex-col lg:flex-row justify-center items-center space-x-8 px-6">
                ...
                <div className="flex flex-col items-center mb-8">
                    {/* Link href="URL" */}
                    <Image src="/images/vempo.png" alt="Vempo image" width={300} height={200} className="rounded-lg shadow-lg transition-transform transform hover:scale-105 shadow-black p-1 bg-gray grayscale hover:filter-none z-1" />
